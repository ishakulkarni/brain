...
switch ext
    ...
    case '.dfs' %Added by Isha Kulkarni,University of Southern California
        dfsfile = readdfs(MF)
        vertex_number = size(dfsfile.vertices,1);
        coord = dfsfile.vertices';
        ntri = size(dfsfile.faces,1);
        tri = dfsfile.faces;
